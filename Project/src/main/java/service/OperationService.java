...
public class OperationService {
	...
	public String getCodeInParticularLanguage(String operation, String language) {
		...
		case "Addition":
			...
			case "C++":
				return "<h2><br>int add(int args[]) {<br>" + "		int sum = 0;<br>"
						...
						+ "		}<br>" + "		return sum;<br>" + "	}</h2>";
			case "Java":
				return "<h2><br>public int add(List<Integer> arrayList) {<br>"
						+ "		return arrayList.stream().reduce(0, (sum, element) -> sum + element);<br>" + "	}</h2>";
			case "Python":
				return "<h2><br>def add_numbers(x,y):<br>" + "   for num in x:<br>" + "    sum=x[i]+sum</h2>";
			}
			break;
		...
		case "Subtraction":
			...
			case "Python":
				return "<h2><br>def subtract_numbers(x,y):<br>" + "   result = x - y<br>" + "   return result</h2>";
			}
			break;
		...
		case "Multiplication":
			...
			case "C++":
				return "<h2><br>int multiply(int args[]) {<br>" + "		int product = 1;<br>"
						...
						+ "		}<br>" + "		return product;<br>" + "	}</h2>";
			case "Java":
				return "<h2><br>public int multiply(List<Integer> arrayList) {<br>"
						+ "							return arrayList.stream().reduce(1, (product, element) -> product * element);<br>"
						+ "						}</h2>";
			case "Python":
				return "<h2><br>def multiply_numbers(x,y):<br>" + "   product = x * y<br>" + "   return product</h2>";
			}
			break;
		...
		case "Division":
			...
			case "Python":
				return "<h2><br>def divide_numbers(x,y):<br>" + "   result = x / y<br>" + "   return result</h2>";
			}
			break;
		default:
